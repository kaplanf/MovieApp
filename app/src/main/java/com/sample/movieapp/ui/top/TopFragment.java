...
public class TopFragment extends BaseFragment implements TopMvpView, MovieListAdapter.Callback {
  ...
  private void loadFromDb() {
    Observable.fromIterable(
        getRealm().where(MovieResponse.class).equalTo("category", 0).findFirst().getResults())
