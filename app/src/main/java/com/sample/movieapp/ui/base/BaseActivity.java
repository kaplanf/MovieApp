...
import com.sample.movieapp.di.component.DaggerActivityComponent;
import com.sample.movieapp.di.module.ActivityModule;
import com.sample.movieapp.util.CommonUtils;
...
public abstract class BaseActivity extends AppCompatActivity
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mActivityComponent = DaggerActivityComponent.builder()
                ...
                .applicationComponent(((MovieApplication) getApplication()).getComponent())
                .build();
